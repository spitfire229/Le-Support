         ...
         if (data.podcasts.L3) {
            data.podcasts.L3.forEach(item => {
                ...
                document.getElementById('podcasts').appendChild(div);
                 ...
                 if (data.ytb_videos.L3) {
                    data.ytb_videos.L3.forEach(item => {
                        const div = document.createElement('div');
