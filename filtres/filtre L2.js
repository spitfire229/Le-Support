         ...
         if (data.podcasts.L2) {
            data.podcasts.L2.forEach(item => {
                ...
                document.getElementById('podcasts').appendChild(div);
                 ...
                 if (data.ytb_videos.L2) {
                    data.ytb_videos.L2.forEach(item => {
                        const div = document.createElement('div');
