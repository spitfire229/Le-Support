         ...
         if (data.podcasts.L1) {
            data.podcasts.L1.forEach(item => {
                ...
                document.getElementById('podcasts').appendChild(div);
                 ...
                 if (data.ytb_videos.L1) {
                    data.ytb_videos.L1.forEach(item => {
                        const div = document.createElement('div');
