         ...
         if (data.podcasts.M2) {
            data.podcasts.M2.forEach(item => {
                ...
                document.getElementById('podcasts').appendChild(div);
                 ...
                 if (data.ytb_videos.M2) {
                    data.ytb_videos.M2.forEach(item => {
                        const div = document.createElement('div');
